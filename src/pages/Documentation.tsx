...
const sections = [
  ...
  { id: 'team-performance', label: 'Team Performance Dashboard', icon: Users },
  { id: 'revenue-attribution', label: 'Revenue Attribution', icon: PieChart },
  { id: 'sequence-testing', label: 'Sequence A/B/C/D Testing', icon: Zap },
  { id: 'multi-channel', label: 'Multi-Channel Sequences', icon: Workflow },
  { id: 'ai-personalization', label: 'AI Personalization', icon: Zap },
  { id: 'waterfall-finder', label: 'Waterfall Email Finder', icon: Search },
