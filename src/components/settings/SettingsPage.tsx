...
import { Key, Mail, MessageCircle, Phone, Save, ExternalLink, Loader2, Webhook } from 'lucide-react';
...
import { CRMWebhookIntegration } from './CRMWebhookIntegration';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">Configure your API credentials, integrations, and webhooks</p>
      </div>
